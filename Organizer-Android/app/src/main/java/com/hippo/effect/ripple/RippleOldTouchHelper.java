...
public class RippleOldTouchHelper implements View.OnTouchListener {
    @SuppressWarnings("unused")
    private static final String TAG = RippleOldTouchHelper.class.getSimpleName();

    private final RippleOldDrawable mOwner;
    ...
    public RippleOldTouchHelper(RippleOldDrawable owner){
        mOwner = owner;
    }

...
public class EasyRecyclerView extends RecyclerView implements View.OnClickListener,
    ...
    public interface OnItemClickListener {
         ...
         */
        void onItemClick(EasyRecyclerView parent, View view, int position, long id);
    }
    ...
    public static abstract class Adapter<VH extends ViewHolder> extends RecyclerView.Adapter<VH> {
         ...
         * (e.g. in a click listener), use {@link android.support.v7.widget.RecyclerView.ViewHolder#getPosition()} which will have the
         * updated position.
         *

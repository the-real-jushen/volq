...
public class RippleTouchHelper implements View.OnTouchListener {
    @SuppressWarnings("unused")
    private static final String TAG = RippleTouchHelper.class.getSimpleName();
    ...
    public RippleTouchHelper(RippleDrawable owner){
        mOwner = owner;
    }
